...
function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "2417f242-fc1d-4e89-8816-975d8fa5544b");
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            <h3>Send us a message <img src={meg_icon} alt="" /></h3>
            ...
            <ul>
                <li><img src={mail_icon} alt="" />techmino99@gmail.com</li>
                <li><img src={phone_icon} alt="" />+8801736666955</li>
                <li><img src={location_icon} alt="" />22/A Charakghata Rayer Bazar, Dhaka 1209</li>
            </ul>
        </div>
        <div className="contact-col">
